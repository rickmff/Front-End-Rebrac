...
$Header_PlaceLati = '-23.514433'; // Ex: 13.062616
$Header_PlaceLong = ''; // Ex: 80.229508
// Consulte Latitude/Longitude em http://itouchmap.com/latlong.html

$Header_NomeEmpresa = 'Rebrac'; // Ex: Agência Kombi
$Header_SloganEmpresa = 'Fazendo o que é preciso!'; // Ex: Agência de Web e Design Gráfico
$Header_Endereco = 'Rua Peru, 120'; // Ex: Rua Comendador Hermelino Matarazzo, 204, Vila Santa Rita
$Header_Cidade = 'Sorocaba'; // Ex: Sorocaba
$Header_UF = 'SP'; // Ex: SP
$Header_CEP = ''; //  18080-000
$Header_Pais = 'Brasil';
$Header_Email = 'rebrac@rebrac.com.br'; // Ex: contato@kombidesig.com.br
$Header_Telefone = '(15) 3227-4196'; // Ex: (15)3318-5300
